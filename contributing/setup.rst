...
Before you can start contributing to the NervAI Engine project, you need to set up your development environment. Please follow the steps in the ::ref:`installation guide <./installation>` to install the required dependencies and set up the project. When installing the project using the ``pip install .`` command, add the ``-e`` flag to install the project in editable mode:
